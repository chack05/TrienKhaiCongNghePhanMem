...
if (isset($_POST['login'])) {
    ...
    $remember = isset($_POST['remember']); // Kiểm tra người dùng có chọn "Remember Me" không
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        if (password_verify($password, $user['password'])) {
            ...
            // Nếu "Remember Me" được chọn, lưu thông tin vào cookies
            if ($remember) {
                setcookie('user_id', $user['user_id'], time() + (86400 * 30), "/"); // Lưu cookie trong 30 ngày
            ...
            if ($_SESSION['role'] === 'admin') {
                header('Location: http://localhost/freetruyen/admin');
            } else {
                ...
                header('Location: http://localhost/freetruyen/');
            }
            exit;
        } else {
...
// Tự động đăng nhập nếu cookies tồn tại
  ...
  <style>
    ...
    * {
    ...
    section {
      ...
      background: url('imglogin2.jpg') no-repeat;
